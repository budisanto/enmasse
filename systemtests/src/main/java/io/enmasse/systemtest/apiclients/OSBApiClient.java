...
public class OSBApiClient extends ApiClient {
     ...
     * @throws Exception
     */
    public String provisionInstance(AddressSpace addressSpace) throws Exception {
        JsonObject serviceCatalog = getCatalog();
     ...
     * @throws Exception
     */
    public void deprovisionInstance(AddressSpace addressSpace, String instanceID) throws Exception {
        JsonObject serviceCatalog = getCatalog();
        String serviceId = getAddressSpaceID(serviceCatalog.getJsonArray("services"), serviceName(addressSpace));
        String planId = getAddressSpacePlanID(serviceCatalog.getJsonArray("services"), addressSpace);
     ...
     * @throws Exception
     */
    public String generateBinding(AddressSpace addressSpace, String instanceId, HashMap<String, String> bindings) throws Exception {
        JsonObject serviceCatalog = getCatalog();
        String serviceId = getAddressSpaceID(serviceCatalog.getJsonArray("services"), serviceName(addressSpace));
        String planId = getAddressSpacePlanID(serviceCatalog.getJsonArray("services"), addressSpace);
     ...
     * @throws Exception
     */
    public JsonObject getLastOperation(String instanceId) throws Exception {
        CompletableFuture<JsonObject> responsePromise = new CompletableFuture<>();
    ...
    private String getAddressSpaceID(JsonArray services, String serviceName) {
        ...
        throw new IllegalArgumentException(String.format("Service '{}' doesn't exist", serviceName));
    }
    ...
    private String getAddressSpacePlanID(JsonArray services, AddressSpace addressSpace) {
        ...
        throw new IllegalArgumentException(String.format("Plan '{}' doesn't exist within service '{}'",
    ...
    private String getPlanID(JsonArray plans, String planName) {
        ...
        throw new IllegalArgumentException(String.format("Plan '{}' doesn't exist", planName));
    }
